const User = require("../../model/Sem2/EM2");
const { success, error } = require("../../utils/wrapper");
const EM2 = async (req, res) => {
  try {
...
const studentShowEM2 = async (req, res) => {
  try {
...
const updateEM2Marks = async (req, res) => {
...
module.exports = {EM2 , updateEM2 ,studentShowEM2 , updateEM2Marks};
