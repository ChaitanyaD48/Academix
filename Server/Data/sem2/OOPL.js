const User = require("../../model/Sem2/OOPL");
const { success, error } = require("../../utils/wrapper");
const OOPL = async (req, res) => {
  try {
...
const updateOOPL = async (req, res) => {
...
const studentShowOOPL = async (req, res) => {
  try {
...
const updateOOPLMarks = async (req, res) => {
...
module.exports = { OOPL, updateOOPL, studentShowOOPL, updateOOPLMarks };
